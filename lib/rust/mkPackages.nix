...
with self.lib.rust;
  {
    ...
    rustToolchain = pkgs.rust-bin.fromRustupToolchainFile rustupToolchainFile;
    ...
    pkgsFor = crossSystem:
      if pkgs.hostPlatform.system == crossSystem
      then pkgs
      else if crossSystem == wasm32-wasi
      then pkgs
      else if pkgs.hostPlatform.system == aarch64-darwin && crossSystem == "aarch64-apple-darwin"
      then pkgs
      else if pkgs.hostPlatform.system == aarch64-linux && crossSystem == "aarch64-unknown-linux-gnu"
      then pkgs
      else if pkgs.hostPlatform.system == aarch64-linux && crossSystem == "aarch64-unknown-linux-musl"
      then pkgs
      else if pkgs.hostPlatform.system == x86_64-darwin && crossSystem == "x86_64-apple-darwin"
      then pkgs
      else if pkgs.hostPlatform.system == x86_64-linux && crossSystem == "x86_64-unknown-linux-gnu"
      then pkgs
      else if pkgs.hostPlatform.system == x86_64-linux && crossSystem == "x86_64-unknown-linux-musl"
      then pkgs
  ...
  in
    ...
    // optionalAttrs (targets' ? "aarch64-unknown-linux-musl" && !pkgs.hostPlatform.isDarwin) {
    ...
    // optionalAttrs (targets' ? "aarch64-apple-darwin" && pkgs.hostPlatform.isDarwin || pkgs.hostPlatform.system == aarch64-darwin) {
    ...
    // optionalAttrs (pkgs.hostPlatform.system == x86_64-darwin) {
    ...
    // optionalAttrs (targets' ? "x86_64-unknown-linux-musl" && !pkgs.hostPlatform.isDarwin) {
